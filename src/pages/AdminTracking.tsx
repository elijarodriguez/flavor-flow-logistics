...
export default function AdminTracking() {
  ...
  const updateDelivery = useMutation({
    mutationFn: async (
      ...
      const success = await updateOrder(id, updates);
  ...
  const bulkUpdateStock = useMutation({
    mutationFn: async () => {
      ...
      for (const [id, stock] of updates) {
        ...
        if (!success) throw new Error(`Failed to update product ${id}`);
      }
    },
    onSuccess: () => {
      ...
      toast.success(
        `Stock updated for ${Object.keys(bulkEdits).length} products`,
      );
      setBulkEdits({});
      setBulkMode(false);
    },
  ...
  const handleShipOrder = () => {
    ...
    updateDelivery.mutate({
      ...
      updates: {
        status: "Shipped",
        trackingNumber: trackingForm.tracking_number || null,
    ...
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground mt-1">
          Monitor inventory levels and track order deliveries
        </p>
      </div>
                ...
                <p className="text-xs text-red-700 mt-1">
                  ...
                  {lowStockCount > 0 && (
                    <>
                      ...
                      running low (≤{LOW_STOCK_THRESHOLD} packs).
                    </>
                  )}
                </p>
              </div>
                ...
                ? (
                  <>
                    <Button
                      size="sm"
                      variant="hero"
                      onClick={() => bulkUpdateStock.mutate()}
        ...
        <TabsContent value="delivery" className="space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 text-center">
              <div className="text-2xl font-bold text-blue-700 font-body">
            ...
            ? (
              ...
              >
                ...
                <p className="text-muted-foreground">
                  No orders to track yet. Orders will appear here once they move
                  to Processing.
                </p>
              </div>
            )
      ...
      >
        <DialogContent className="max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription>
              Add courier details and tracking information before marking the
              order as shipped.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-3">
            ...
            <div>
              ...
              <Input
                ...
                placeholder="e.g. J&T Express, LBC, Grab"
              />
            </div>
            <Button
              variant="hero"
